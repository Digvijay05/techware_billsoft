...
class Home:
    ...
    def daily_report(self):
        ...
        self.daily_report_treeview["displaycolumns"] = ("No. of Invoices", "Payments Received", "Avg. Invoices/Day",
                                                        "Cost of Expenses", "Avg. Cost of Expenses/Day")
    ...
    def new_invoice_btn(self):
        ...
        self.new_invoice_window.title("New Invoice")
        ...
        self.invoice_information_lbl = LabelFrame(self.new_invoice_window, text="Invoice Information")
        self.invoice_information_lbl.place(relx=0, rely=0, relwidth=1, relheight=0.22)

        self.partriculars_lbl = LabelFrame(self.new_invoice_window, text="Particulars")
        self.partriculars_lbl.place(relx=0, rely=0.22, relwidth=1, relheight=0.44)

        self.discount_var = IntVar()
        self.discount_chkbox = ttk.Checkbutton(self.new_invoice_window, text="Apply Discount To All",
                                               variable=self.discount_var, onvalue=1, offvalue=0, takefocus=False)
        self.discount_chkbox.place(relx=0, rely=0.77)
        self.new_invoice_window.protocol('WM_DELETE_WINDOW', self.style.theme_use('awlight'))
    ...
    def add_staff_btn(self):
        ...
        self.staff_photo_capture_btn = Button(self.staff_photo_lbl, image=self.staff_photo_capture_btn_image, bd=0)
